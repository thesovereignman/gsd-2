const MOCK_FINDINGS = [
  {
    ...
    endpoint: "/api/admin",
    cve: "N/A",
    discoveredAt: new Date(Date.now() - 2 * 60 * 60 * 1e3).toISOString(),
  ...
  },
  {
    ...
    cve: "N/A",
    discoveredAt: new Date(Date.now() - 5 * 60 * 60 * 1e3).toISOString(),
  ...
  },
  {
    ...
    cve: "N/A",
    discoveredAt: new Date(Date.now() - 24 * 60 * 60 * 1e3).toISOString(),
  ...
  },
  {
    ...
    endpoint: "/auth/login",
    cve: "N/A",
    discoveredAt: new Date(Date.now() - 48 * 60 * 60 * 1e3).toISOString(),
    updatedAt: new Date(Date.now() - 48 * 60 * 60 * 1e3).toISOString()
  },
  {
    id: "V-005",
    ...
    cve: "CVE-2022-24999",
    discoveredAt: new Date(Date.now() - 72 * 60 * 60 * 1e3).toISOString(),
    updatedAt: new Date(Date.now() - 72 * 60 * 60 * 1e3).toISOString()
  },
  {
    id: "V-006",
    ...
    endpoint: "/api/*",
    cve: "N/A",
    discoveredAt: new Date(Date.now() - 96 * 60 * 60 * 1e3).toISOString(),
    updatedAt: new Date(Date.now() - 96 * 60 * 60 * 1e3).toISOString()
  },
  {
    id: "V-007",
    ...
    cve: "N/A",
    discoveredAt: new Date(Date.now() - 7 * 24 * 60 * 60 * 1e3).toISOString(),
...
const MOCK_SCANS = [
  {
    ...
    completedAt: new Date(Date.now() - 1 * 60 * 60 * 1e3).toISOString(),
    findingsCount: 7
  },
  {
    id: "SCAN-2024-002",
    ...
    status: "running",
    startedAt: new Date(Date.now() - 15 * 60 * 1e3).toISOString(),
    completedAt: null,
    findingsCount: 0
  }
];
const MOCK_FR_EVENTS = [
  {
    id: "FR-001",
    type: "block",
...
const MOCK_FR_STATUS = {
  healthy: true,
  activeAgents: 3,
  totalBlocksToday: 12,
  totalScansThisWeek: 8,
  creditsRemaining: 4320,
  plan: "Business",
  updatedAt: (/* @__PURE__ */ new Date()).toISOString()
};

export { MOCK_COMPLIANCE as M, MOCK_FINDINGS as a, MOCK_SCANS as b, MOCK_FR_EVENTS as c, MOCK_FR_STATUS as d };
